...
- `vscode/askQuestions` is a checkpoint renderer, not a task router, preflight substitute, review verdict tool, plan blocker mechanism, write authorization, sync authorization, or build authorization.
