...
- Use `vscode/askQuestions` only for `shape` `Human Decision State: checkpoint`; do not use it instead of repo preflight, `explore`, `review`, `plan`, or any write/execute authorization.
